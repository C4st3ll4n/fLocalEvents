class Event{
  ...
  Event({this.imgPath, this.title, this.description,
      this.location, this.duration, this.punchLine1,
      this.punchLine2, this.categoryIds, this.galleryImages});

}


final fiveKmRunEvent = Event(
    imgPath: "assets/event_images/5_km_downtown_run.jpeg",
...
final cookingEvent = Event(
    imgPath: "assets/event_images/granite_cooking_class.jpeg",
...
final musicConcert = Event(
    imgPath: "assets/event_images/music_concert.jpeg",
...
final golfCompetition = Event(
    imgPath: "assets/event_images/golf_competition.jpeg",
