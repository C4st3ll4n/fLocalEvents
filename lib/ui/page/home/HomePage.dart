...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: ChangeNotifierProvider<AppState>(create: (_)=> AppState(),
        child: Stack(
          children: <Widget>[
            HomePageBackground(
                    ...
                    Padding(
                      ...
                      child: Consumer<AppState>(
                        builder: (ctx, appState,_) => SingleChildScrollView(
                          ...
                          child: Row(
                            children: <Widget>[
                              for (final categoria in categories) CategoryWidget(categoria: categoria,)
                            ],
                          ),
                        ),
                      ),
                    ...
                    Padding(
                      ...
                      child: Consumer<AppState>(
                        builder:(ctx,appState,_)
                            => Column(
                              children: <Widget>[for(final event in events.where((e)=>e.categoryIds.contains(appState.selectedCategoryId)))
                                GestureDetector(onTap: (){
                                  //Navigator.push(context, MaterialPageRoute(builder: (_)=))
                                },
                                child: EventWidget(evento: event,),)],
                            )
                      ),
                    )
                  ],
